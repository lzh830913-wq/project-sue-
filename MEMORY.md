...
### 还书义务工程化 ✅（2026-06-02 完成）
- persona-switch SKILL.md Procedure B 新增 Step 4 "还书义务"：雯道别前检查当天daily，确认静雯时段是否已记录，如有遗漏帮补入事实经历
- SOUL.md 雯章节"切换回去时"新增还书义务条款
- 备份：memory/backup/2026-06-02/
- 下一步：切出时静雯自动生成上下文摘要（尚未实现）
